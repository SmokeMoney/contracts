...
contract SetupScript is Script {
    ...
    address wsteth_SCROLL_Address = 0xDF52714C191e8C4EC26cCD5B1578a904724e93b6;
    ...
    function run(uint8 config) external {
        ...
        if (config == 1) {
            ...
            depositContract = new SmokeDepositContract(
                ...
                weth_SCROLL_Address,
                wsteth_SCROLL_Address,
                BASEID, // adminchain ID
                SCROLLID, // current chain ID
                lz_endpoint,
                owner
            );
            ...
            spendingContract = SmokeSpendingContract(spending_SCROLL_Address);
            depositContract = SmokeDepositContract(deposit_SCROLL_Address);
            ...
            spendingContract = SmokeSpendingContract(spending_SCROLL_Address);
            uint256 wethBalance = IWETH2(weth_SCROLL_Address).balanceOf(address(spendingContract));

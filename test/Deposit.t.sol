...
contract DepositTest is TestHelperOz5 {
    ...
    function testDeposit() public {
        ...
        assertEq(deposit.getDepositAmount(issuer1NftAddress, tokenId, address(weth)), 1 * 10**18);
    }
    ...
    function testWithdraw() public {
        ...
        vm.stopPrank();
        assertEq(deposit.getDepositAmount(issuer1NftAddress, tokenId, address(weth)), 0.9 * 10**18);
    }
}
...
contract DepositTest is Test {
    ...
    function testBorrow() public {
        ...
        console.log("Lending  pos", lendingcontract.getLendPosition(tokenId));
        console.log("");
        ...
        vm.startPrank(user3);
        lendingcontract.repayOrLend{value: 25 ether}(tokenId);
        vm.stopPrank();
        console.log("");
        console.log("user debt", lendingcontract.getNetPosition(tokenId, user2)); 
        console.log("Borrow pos", lendingcontract.getBorrowPosition(tokenId, user2));
        ...
        console.log("Lending  pos", lendingcontract.getLendPosition(tokenId));
        vm.startPrank(user3);
        lendingcontract.repayOrLend{value: 25.500017202568039109 ether}(tokenId);
        vm.stopPrank(); 
    ...
    function testRepay() public {
        vm.startPrank(user3);
        lendingcontract.repayOrLend{value: 0.1 ether}(tokenId);
        vm.stopPrank();
